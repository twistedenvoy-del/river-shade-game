...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Show journal notification if just unlocked and on index
    if (scene === 'index' && localStorage.getItem('journalJustUnlocked') === 'true') {
      localStorage.removeItem('journalJustUnlocked');
      
      if (window.showJournalUnlockNotification) {
        setTimeout(() => {
          window.showJournalUnlockNotification();
        }, 2000);
      }
    }
  });
